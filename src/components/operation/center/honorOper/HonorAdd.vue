      ...
      addHonor(honorFrom) {
        this.$refs[honorFrom].validate((valid) => {
          ...
          if (valid) {
            ...
            this.honorFrom.proofMaterialId = this.honorFrom.stuId +"_"+ this.honorFrom.honorType + "_" + this.honorFrom.honorLevel + "_" + this.honorFrom.honorGrade + "_" + this.checkCode + "_1.jpg"
