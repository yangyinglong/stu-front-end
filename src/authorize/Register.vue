<template>
	<div class="lab-main">
		<div class="content">
			<!-- <el-form label-position='right' :model="registerData" status-icon :rules="rules" ref="registerData" label-width="100px" class="demo-ruleForm" style="margin-right: 30px">
				<br><br>
				<el-form-item label="学号：" prop="studentId">
	            	<el-input v-model="registerData.studentId" placeholder="用户登录" style="width: 300px"></el-input>
	            </el-form-item>
				...
				<el-form-item label="密码：" prop="password">
					<el-input type="password" v-model="registerData.password" autocomplete="off" style="width: 300px"></el-input>
				</el-form-item>
				<el-form-item label="确认密码：" prop="checkPass">
					<el-input type="password" v-model="registerData.checkPass" autocomplete="off" style="width: 300px"></el-input>
				</el-form-item>
				...
				this.$refs[registerData].validate((valid) => {
					if (valid) {
						var registerFormData = {
							stuId: this.registerData.studentId,
